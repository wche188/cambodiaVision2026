 ...
 *
 * Statuses:
 *   Registered → Form_Printed (after registration form is downloaded)
 *   Registered → Seen_by_GP (after GP exam submitted)
 *   Form_Printed → Seen_by_GP
 *   In_Progress (legacy) → Seen_by_GP
 *   Seen_by_GP → Surgery_Eligible | Not_Eligible
 *   Surgery_Eligible → Prepare_for_Surgery | Surgery_Scheduled
 *   Prepare_for_Surgery → Surgery_Completed
 *   Surgery_Scheduled → Surgery_Completed
 *   Surgery_Completed → Complete
 *   Not_Eligible → Complete
 *   Complete is terminal
 */
const VALID_TRANSITIONS = {
  Registered:          ['Form_Printed', 'Seen_by_GP'],
  Form_Printed:        ['Seen_by_GP'],
  In_Progress:         ['Seen_by_GP', 'Surgery_Eligible'],
  Seen_by_GP:          ['Surgery_Eligible', 'Not_Eligible'],
  Surgery_Eligible:    ['Prepare_for_Surgery', 'Surgery_Scheduled'],
  Prepare_for_Surgery: ['Surgery_Completed'],
  Surgery_Scheduled:   ['Surgery_Completed'],
 ...
 * @param {string} fromStatus — current patient.status
...
/**
 * Return the list of statuses a patient can transition to from the given state.
